...
{
    int index = hash(record->id, tableSize); // Compute hash value
...
int main(void)
{
    ...
    {
        insertRecord(hashTable, &pRecords[i], hashTableSize); // Insert records into hash table
    }

    displayRecordsInHash(hashTable, hashTableSize); // Display records in hash table
